...
<style>
    ...
    .greenbtn {
        background-color: rgb(133,112,181);
...
<body>
<img class="wal" src="images/wal.jpg" alt="walp">
...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
            <div class="innerdiv">
                <div class="row"><img class="imglogo" src="images/wce.jpeg" /></div>
                ...
                <div class="rightinnerdiv">
                    <div id="addbook" class="innerright portion" style="<?php  if(!empty($_REQUEST['viewid'])){ echo " display:none ";} else {echo " "; }?>">
                        ...
                        <form action="addbookserver_page.php" method="post" enctype="multipart/form-data">
                            ...
                            <div>Branch:<input type="radio" name="branch" value="other" />other<input type="radio" name="branch" value="BSIT" />BSIT
                                <div style="margin-left:80px"><input type="radio" name="branch" value="BSCS" />BSCS<input type="radio" name="branch" value="BSSE" />BSSE</div>
                            </div>
